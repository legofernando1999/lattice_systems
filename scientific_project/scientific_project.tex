...
\subsection{The Free Time-Independent One-Dimensional Periodic Schrödinger Equation}
...
\begin{equation*}
    H \psi(x) = -\frac{1}{2}\frac{\diff^2}{\diffx^2}\psi(x) = E \psi(x), \quad \text{for} \; 0 \leq x \leq L, \quad \text{with} \; \psi(0) = \psi(L)
\end{equation*}
...
This allows us to express the Hamiltonian, $H_{\text{Discrete}} \in \mathcal{L} (\ell^2(\mathbb{Z}))$, in matrix form as 
