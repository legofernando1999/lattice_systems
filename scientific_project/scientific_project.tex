...
and therefore $\Vert \left( H - \lambda \right) v_1 \Vert = s_1 \Vert u_1 \Vert = s_1$. We conclude that $\Vert \left( H - \lambda \right) v_1 \Vert \leq s_1 = \varepsilon_{r, \lambda, x}$, and thus $v_1$ is an $\varepsilon_{r, \lambda, x}$-quasimode, which implies that $\lambda \in \sigma_{\varepsilon_{r, \lambda, x}} (H)$ by definition of the spectrum.
