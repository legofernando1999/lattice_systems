...
In order to validate the pseudospectral inclusion bound for this operator, first we need to take an uneven section. Given the simplicity of $H_{\text{free}}$, any uneven section will do. For instance, let $r = 50$, $x = L/2$ and $\lambda \in \mathbb{R}$, then 
...
\[
    ...
    \tikz[overlay,remember picture] {
        \node[above of=uneven_section, xshift=45pt, yshift=9pt] {$Q_{r, x, \lambda}$};
    }
\]
